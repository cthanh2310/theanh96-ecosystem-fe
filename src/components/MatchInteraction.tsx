...
export default function MatchInteraction() {
  ...
  return (
    <div className='max-w-4xl mx-auto p-6 space-y-8'>
      ...
      <div className='bg-gray-800 rounded-lg p-6 text-white'>
        <div className='flex items-center justify-between mb-6'>
          <div className='flex items-center space-x-4'>
            ...
            <div>
              <h2 className='text-2xl font-semibold'>500Bros</h2>
              <p className='text-gray-400 text-sm'>Professional Team</p>
            </div>
          </div>

          <div className='text-center'>
            <div className='bg-red-500 text-white px-4 py-1 rounded-full text-sm font-semibold mb-2'>
          ...
          <div className='flex items-center space-x-4'>
            <div>
              <h2 className='text-2xl font-semibold text-right'>Theanh96</h2>
        ...
        <div className='grid grid-cols-2 gap-4 mt-6 p-4 bg-gray-700/50 rounded-lg'>
      ...
      {/* Match Prediction */}
      <div className='bg-gray-800 rounded-lg p-6 text-white'>
        <h2 className='text-2xl font-semibold mb-4'>Predict the Match</h2>
              ...
              {predictions.map(prediction => (
                ...
                >
                  ...
                  <input
                    ...
                    className='w-20 px-4 py-2 rounded bg-gray-700 text-white'
                  />
                </div>
              ))}
            </div>
                ...
                {predictions.map((prediction) => (
                  ...
                  >
                    <div className='flex items-center justify-center space-x-2'>
                      ...
                      <span className='font-semibold'>{prediction.team}</span>
                    </div>
                  </button>
                ))}
              </div>
      ...
      {/* Player Registration */}
      <div className='bg-gray-800 rounded-lg p-6 text-white'>
        <h2 className='text-2xl font-semibold mb-4'>Register to Play</h2>
        <div className='space-y-4'>
          <div>
          ...
          <button className='w-full bg-purple-500 hover:bg-purple-600 px-4 py-2 rounded'>
            Register to Play
          </button>
        </div>
      </div>
